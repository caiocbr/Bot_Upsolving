...
def get_cells(sheet, spreadsheet_id, range):
...
def get_users_end_column_id(sheet, spreadsheet_id):
...
def get_problems_end_row(sheet, spreadsheet_id):
    ...
    problems_quantity = get_cells(sheet, spreadsheet_id, range)
    problems_end_row = 0
...
def get_user_column_id(sheet, spreadsheet_id, user_name):
    ''' Pega a ID da planilha e o nome do usuário
        Retorna a ID da coluna do usuário ou None caso não seja encontrado '''

    users_end_column_id = get_users_end_column_id(sheet, spreadsheet_id)
...
def get_contest_first_row(sheet, spreadsheet_id, contest_name):
...
def get_contest_last_row(sheet, spreadsheet_id, contest_name):
    ''' Pega a ID da planilha e o nome da prova
...
def get_problem_row(sheet, spreadsheet_id, contest_first_row, contest_last_row, problem_name):
...
def insert_columns(sheet, spreadsheet_id, tab_id , start_column_id , column_quantity):
...
def delete_columns(sheet, spreadsheet_id, tab_id , start_column_id , column_quantity):
    ''' Pega a ID da planilha, a ID da aba da planilha,
...
def format_problem_cells(sheet, spreadsheet_id, tab_id, start_row, start_column_id, end_row, end_column_id):
    ''' Pega a ID da planilha, a ID da aba da planilha,
...
def change_column_size(sheet, spreadsheet_id, tab_id, start_column_id, column_quantity, size):
    ''' Pega a ID da planilha, a ID da aba da planilha,
...
def centralize_cells(sheet, spreadsheet_id, tab_id, start_row, start_column_id, end_row, end_column_id):
    ''' Pega a ID da planilha, a ID da aba da planilha,
        a linha e a ID da coluna onde começará a formatação 
        e a linha e a ID da coluna onde terminará a formatação
...
def bold_cells(sheet, spreadsheet_id, tab_id, start_row, start_column_id, end_row, end_column_id):
    ''' Pega a ID da planilha, a ID da aba da planilha,
        a linha e a ID da coluna onde começará a formatação 
        e a linha e a ID da coluna onde terminará a formatação
...
def external_border(sheet, spreadsheet_id, tab_id, start_row, start_column_id, end_row, end_column_id):
    ''' Pega a ID da planilha, a ID da aba da planilha,
        a linha e a ID da coluna onde começará a formatação 
        e a linha e a ID da coluna onde terminará a formatação
...
def set_text_rotation(sheet, spreadsheet_id, tab_id, start_row, start_column_id, end_row, end_column_id, angle):
    ''' Pega a ID da planilha, a ID da aba da planilha,
        a linha e a ID da coluna onde começará a formatação 
        e a linha e a ID da coluna onde terminará a formatação
        e quantos graus se deseja rotacionar o Texto das células selecionadas
...
def format_user_cells(sheet, spreadsheet_id, tab_id, row, column_id):
